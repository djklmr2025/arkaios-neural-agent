...
echo [3/4] Iniciando la Interfaz Grafica (Frontend React + Electron)...
start "ARKAIOS - Interfaz UI" cmd /k "cd /d C:\ARKAIOS\neuralagentAI-main\desktop && npm start"

echo [4/4] Iniciando Los Ojos de Antigravity (Puente MCP)...
start "ARKAIOS - Ojos (MCP)" cmd /k "cd /d ""C:\ARKAIOS\Agente Autonomo MVP\mcp_server"" && Arrancar_Ojos_Antigravity.bat"
